...
* ATTENTION: This gem will be terminated on January 1, 2014! See README for details.

= v2.3.0

* ATTENTION: This gem will be terminated on 2014-1-1. See README for details.
* Added Guard support.
* Added contributing documentation.
* Added spec focus capability.
* Added enhanced_select method specs.
* Added Gem Badge support.
* Added image alt tag for Travis CI build status.
