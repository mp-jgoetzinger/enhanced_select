...
* *UNIX*: gem install enhanced_select
* *Windows*: gem install enhanced_select

Update your Gemfile to include the new gem:

  gem "enhanced_select"

...or if still using the environment.rb file:
