...
{<img src="https://secure.travis-ci.org/bkuhlmann/enhanced_select.png" />}[http://travis-ci.org/bkuhlmann/enhanced_select]
...
Please log all feedback/issues via {GitHub Issues}[https://github.com/bkuhlmann/enhanced_select/issues]. Thanks.
